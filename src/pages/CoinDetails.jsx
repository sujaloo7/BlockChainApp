import { Box, Container, HStack, Image, Radio, RadioGroup, Stat, StatHelpText, StatLabel, StatNumber, Text, VStack , StatArrow, Badge, Progress } from '@chakra-ui/react'
   ...
   <Container maxW={"container.xl"}>
    {
        loading? <Loader/>:
        <>
        {/* <Box width={"full"} borderWidth={"1"}><Chart/></Box> */}
        ...
        <RadioGroup value={currency} onChange={setCurrency} p={"8"}>
          ...
          <VStack spacing={"4"} p={"16"} alignItems="flex-start">
            ...
            <CustomeBar high={`${currencySymbol}${coins.market_data.high_24h[currency]}`} low={`${currencySymbol}${coins.market_data.low_24h[currency]}`}/>
